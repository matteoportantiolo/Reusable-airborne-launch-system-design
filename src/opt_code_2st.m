...
stage2.TW = 1.3;           % Thrust-to-weight ratio
...
lb = [200, deg2rad(0.001), 9e3, 0.01, 120, 0.01]; % Lower bounds
ub = [v_c, deg2rad(2), 12e3, stage1.t_burn, 500, stage2.t_burn]; % Upper bounds

% ========================================================================
%% OPTIMIZATION
% ========================================================================
initial_guess = [v_c-10, deg2rad(1), 11e3, stage1.t_burn-10, 200, stage1.t_burn-10]; % [v0, gamma0, h0, t_bo1, delta_t, t_bo2]
...
[x_opt, delta_v_opt] = fmincon(@(x) ObjFun(x, stage1, stage2), ...
    initial_guess, [], [], [], [], lb, ub, ...
    @(x) myconstraints(x, stage1), options);
...
function [c, ceq, G, Geq] = myconstraints(x_vect, param_1st)
